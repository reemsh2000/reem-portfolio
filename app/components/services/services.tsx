export default function Services() {
	return (
		<div id="services" className="p-5 flex flex-col items-center my-20">
			...
			<div className="md:h-65 md:bg-amber-300 flex flex-col items-center rounded-2xl py-6 ">
				<p className="bg-amber-300  md:bg-none
				 h-full w-full
				 rounded-2xl
				 md:rounded-none
				 p-10 
				 md:p-1
				 md:h-2/3 md:w-1/2 my-10 text-center dark:text-black">As a frontend developer, I specialize in bringing ideas to life with clean code and modern design. From dynamic web apps to seamless user experiences, I deliver high-quality interfaces that are fast, responsive, and built to scale.</p>
