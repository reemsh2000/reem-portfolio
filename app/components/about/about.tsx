		...
		<div id="about" className="flex flex-col md:flex-row justify-between" >
			...
			<div className="about-section p-8 w-full md:w-1/2 flex justify-center">
				<div className="py-5 w-full max-w-md flex flex-col justify-center">
					<span className="font-semibold my-2 text-xs text-amber-300">Front-end Developer</span>
					...
					<div className="mt-5 flex flex-wrap gap-2">
						...
						<Link href="https://www.linkedin.com/in/reem-shamia/">
							<button type="button" className="text-white bg-blue-700 hover:bg-gray-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 dark:hover:text-white">
								LinkedIn
							</button>
						</Link>
					</div>
						<Link className="my-3"role="button" href="/Reem Shamia Front-end Developer.pdf">
							<button
								type="button"
								className="py-2.5 px-5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-amber-300 hover:text-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
								Download Reem&apos;s Cv
							</button>
						</Link>
